...
Details:
  Source:   bundled
  Path:     ~/.coco/skills/github/SKILL.md
...
2. Managed skills    ~/.coco/skills/              (user-installed)
...
Existing JSON skills in `~/.coco/skills/*.json` continue to work. The loader checks both:
