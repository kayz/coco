...
官方云中继地址：
- WebSocket: `wss://keeper.kayz.com/ws`
- Webhook: `https://keeper.kayz.com/webhook`
- 信任 IP: `106.52.166.51`
...
```bash
# 克隆项目
git clone https://github.com/kayz/coco.git
cd lingti-bot
...
2. 点击「设置接收消息」
3. 配置以下内容：
   - URL: `https://your-domain.com/wecom`（或官方地址 `https://keeper.kayz.com/wecom`）
   - Token: 自定义一个字符串，记住它
