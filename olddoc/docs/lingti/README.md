...
# lingti-bot (灵小缇 [coco.kayz.com/bot](https://coco.kayz.com/bot))

> 🐕⚡「**极简至上 效率为王 一次编译 到处执行 极速接入**」的 AI Bot

[![Go Version](https://img.shields.io/badge/Go-1.23+-00ADD8?style=flat&logo=go)](https://go.dev/)
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Website](https://img.shields.io/badge/官网-coco.kayz.com-blue?style=flat)](https://coco.kayz.com/bot)
...
# 然后去企业微信后台配置回调 URL: https://keeper.kayz.com/wecom
```

**工作原理：**

```
企业微信(用户消息) --> keeper.kayz.com(云中继) --WebSocket--> lingti-bot(本地AI处理)
```
...
# 3. 去企业微信后台配置回调 URL: https://keeper.kayz.com/wecom
...
> **为什么是 coco.kayz.com/bot 而不是 keeper.kayz.com？**
>
...
所有配置项按以下优先级解析：**命令行参数 > 环境变量 > 配置文件 (`~/.coco.yaml`)**
...
| 路径 | 说明 |
|------|------|
| `~/.coco.yaml` | 配置文件（AI 服务、平台密钥等） |
| `~/.coco.db` | SQLite 数据库（定时任务等持久化数据） |
| `~/.coco.db-wal` | SQLite WAL 日志（自动管理，勿手动删除） |
| `~/.coco.db-shm` | SQLite 共享内存（自动管理，勿手动删除） |
| `~/.coco-bot/browser/` | 浏览器自动化的用户数据目录 |
...
本项目完全在 **[lingti-code](https://coco.kayz.com/code)** 环境中编写完成。
...
更多信息请访问：[官网](https://coco.kayz.com/code) | [GitHub](https://github.com/ruilisi/lingti-code)
