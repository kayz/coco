...
[![Website](https://img.shields.io/badge/Website-coco.kayz.com-blue?style=flat)](https://coco.kayz.com/bot)
...
**Quick Start:**
1. Install lingti-bot: `curl -fsSL https://coco.kayz.com/install.sh | bash -s -- --bot`
...
Task configuration saved to `~/.coco.db` (SQLite), auto-resume after MCP service restart.
...
- Website: [coco.kayz.com](https://coco.kayz.com/bot)
